...
public class Shape {
    ...
    private boolean touchRight() {
        ...
        for (int i = 0; i < arrayShape.length; i++) {
            ...
            if (y - arrayShape.length + i >= 0 && x + j + 1 < field[0].length -
                    arrayShape[0].length && field[y - arrayShape.length + i][x + j + 1]) {
                return true;
            }
        }
        return false;
    ...
    public void rotate() {
        ...
        for (boolean[] anArrayShape : arrayShape) {
            int jj = 0;
            for (int j = arrayShape[0].length - 1; j >= 0; j--) {
                rotationArray[jj][ii] = anArrayShape[j];
    ...
    private void generateShape() {
        ...
        switch ((int) d) {
            case 0:
                arrayShape = new boolean[][]{{true, true, false}, {false, true, true}};
                break;
            case 1:
                arrayShape = new boolean[][]{{false, true, false}, {true, true, true}};
                break;
            case 2:
                arrayShape = new boolean[][]{{true, true, true, true}};
                break;
            case 3:
                arrayShape = new boolean[][]{{true, false, false}, {true, true, true}};
                break;
            case 4:
                arrayShape = new boolean[][]{{false, false, true}, {true, true, true}};
                break;
            case 5:
                arrayShape = new boolean[][]{{true, true}, {true, true}};
                break;
            case 6:
                arrayShape = new boolean[][]{{false, true, true}, {true, true, false}};
                break;
        }
